...
def execute(appResources, appContext):
    ...
    urlWithParams = 'crs=EPSG:3857&dpiMode=7&format=image/jpeg&layers=lb&styles=farbe&tileMatrixSet=google3857&url=https://maps.wien.gv.at/wmts/1.0.0/WMTSCapabilities-arcmap.xml'

    appContext.steps.gis.ortho.provider = "wms"
    appContext.steps.gis.ortho.input_file = urlWithParams
